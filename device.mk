...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/media/media_codecs_performance_khaje_v0.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_performance_khaje_v0.xml \
...
# Inherit vendor
$(call inherit-product, vendor/xiaomi/topaz_global/topaz_global-vendor.mk)